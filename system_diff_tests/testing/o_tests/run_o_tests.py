...
Beispiel:
    python run_o_tests.py "C:/pfad/zum/system" "C:/pfad/zum/output"
"""
...
def main():
    if len(sys.argv) < 2:
        ...
        print("\nBeispiel:")
        print('  python run_o_tests.py "C:\\...\\recludOS"')
        print('  python run_o_tests.py "C:\\...\\recludOS" "C:\\...\\output\\recludOS"')
