"""
Feature-Mapping Database - Initial Data Population
"""
import sqlite3
import sys
import json
...
from config import DB_PATH as _DB_PATH, get_system_path
...
# ═══════════════════════════════════════════════════════════════════════════
systems = [
    ("_CHIAH", "system", "3.1", "SKILL.md", str(get_system_path("_CHIAH"))),
    ("_BATCH", "system", "2.5", "SKILL.md", str(get_system_path("_BATCH"))),
    ("recludOS", "system", "3.3.0", "boot/SKILL.md", str(get_system_path("recludOS") / "main" / "system")),
    ("BACH_STREAM", "meta", "1.1", "SKILL.txt", str(get_system_path("BACH_STREAM"))),
    ("AI-Portable", "utility", "1.0", None, str(get_system_path("AI-Portable"))),
    ("Templates", "utility", "1.0", None, str(get_system_path("Templates"))),
    ("recludos-filecommander-mcp", "utility", "1.0", "src/index.ts", str(get_system_path("recludos-filecommander-mcp"))),
]
